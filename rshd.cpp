    ...
    openErrSocket (SOCKET rshClient, SOCKET& rshClientErr, char* buff)
{
    ...
    if(debugFlag)
        fprintf(stderr, "[%d] Local stderr port: %d...\n", client, lport);
...
VOID ServiceStart (DWORD dwArgc, LPTSTR *lpszArgv)
{
    ...
    //
        ...
        AddInfoToMessageLog("RSH Daemon service started.");
    loop();
    ...
    WSACleanup();
        AddInfoToMessageLog("RSH Daemon service stopped.");
}
